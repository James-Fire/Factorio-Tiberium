...
LSlib.recipe.addResult("tiberium-farming", "tiberium-ore", OrePerCredit+OrePerCredit*0.8, "item")
LSlib.recipe.addResult("tiberium-farming", "tiberium-data", OrePerCredit*0.2, "item")
...
if (mods["bobores"]) then
	...
	local DirectRecipeOutput = TotalCentOutput*0.8*RecipeMult --0.8 so that direct recipes are only 80% efficient compared to centrifugin, but they do focus.
	...
	LSlib.recipe.editResult("tiberium-molten-to-uranium-ore", "stone", "uranium-ore", 0.25)
	LSlib.technology.addRecipeUnlock("advanced-tiberium-transmutation-tech", "tiberium-molten-to-uranium-ore")
	...
	if (mods["angelsrefining"]) then
		...
		LSlib.recipe.duplicate("tiberium-molten-to-uranium-ore", "tiberium-molten-to-thorium")
